...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manager.beginTransaction().replace(R.id.content_main, timerFragment, timerFragment.getTag()).commit();
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        //    manager.beginTransaction().replace(R.id.content_main, historyFragment, historyFragment.getTag()).commit();
            ...
            FragmentManager manager = getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.content_main, rulesFragment, rulesFragment.getTag()).commit();
